...
- [ ] consistent message bar styling — uniform dim style for all messages; distinguish type with a bracketed tag prefix: `[error]`, `[ok]`, `[info]`; no colour emphasis on body or tag
